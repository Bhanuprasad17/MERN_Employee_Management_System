    ...
    const fetchEmployees = async () => {
      ...
      try {
        const response = await axios.get(
          "https://mern-employee-management-system-1.onrender.com/api/employee",
          {
            headers: {
          ...
          const data = await response.data.employees.map((emp) => ({
            ...
            profileImage: (
              <div className="flex items-center justify-center">
                <img 
                  src={`https://mern-employee-management-system-1.onrender.com/uploads/${emp.userId.profileImage}`} 
                  alt={emp.userId.name}
